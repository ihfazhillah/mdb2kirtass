...
sidu,3,kertas putih,4,3""".strip())
    ...
    def test_update_xml_objek_header_attrib_value_dan_key_diganti(self):
        """value dari attribut suatu tag adalah key dari sebuah dictionary,
        dan akan diganti dengan value yang sesuai.
        ...
        expected = """<parent>
        <root id='1'>
        <groupe bk='nama' no='1' betaka='ini buku bagus' aut='bagus' cat='3'/>
        <groupe bk='munawir' no='2' betaka='kamus indo arab' aut='anang' cat='4'/>
        <groupe bk='sidu' no='3' betaka='kertas putih' aut='adit' cat='3'/>
        </root>
        <root id='2'/>
        </parent>"""
        # self.fail(etree.tostring(hasil))
